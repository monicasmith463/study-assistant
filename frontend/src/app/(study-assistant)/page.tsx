      ...
      <section className="from-brand-50 to-blue-light-50 dark:from-brand-950/20 dark:to-blue-light-950/20 relative z-1 overflow-hidden bg-gradient-to-br via-white px-6 py-20 sm:py-24 lg:py-32 dark:via-gray-900">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            {/* Right: File Icons Animation */}
            <div className="group relative flex items-center justify-center">
              <div className="flex w-full items-center justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12">
                <img
                  src="/pdf.svg"
                  alt="PDF"
                ...
                <img
                  src="/powerpoint.svg"
                  alt="PowerPoint"
                  className="animate-float-slow-delay w-32 -translate-x-4 translate-y-2 rotate-0 transition-all duration-700 ease-in-out group-hover:translate-y-0 sm:w-40 sm:-translate-x-5 md:w-48 md:-translate-x-6 lg:w-56 lg:-translate-x-6 xl:w-64 xl:-translate-x-6"
                />
                <img
                  src="/word.svg"
                  alt="Word"
